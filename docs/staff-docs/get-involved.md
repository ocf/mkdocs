...
To get the latest OCF updates, be sure to join [the bridged OCF Chat][../user-docs/contact/chat.md]. These are the more popular channels:
...
[Read more about other mailing lists available to join](../staff-docs/mailing-lists.md)

### In-person meetings

We hold two meetings every Wednesday during the fall and spring semesters. We usually begin holding BoD Meetings in the first week of instruction, and General Meetings the following week, but you should check the [OCF Chat](../user-docs/contact/chat.md) to confirm.
